...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Power of Death - Contacts</title>
...
<p align="center" class="hmain">Контакты</p>
  <hr/>
</div>
<nav>
  <hr/>
    ...
    <hr/>
		...
		<content>
<p class="Text">Рекомендуем вам так же заглянуть и в наши соц.сети, там интересно!)</p>
<p class="Text">Мы есть в следующих соц.сетях:</p>
  </content>
  <hr/>
	<footer>
    <table>
